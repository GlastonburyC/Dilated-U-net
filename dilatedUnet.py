...
class UNet():
    ...
    def compile(self,addition,classes,dilate,dilate_rate,loss=bce_dice_loss):
        ...
        down1 = Conv2D(44, 3, activation='relu', padding='same', kernel_initializer='random_uniform')(x)
        b1 = BatchNormalization()(down1)
        b1 = Dropout(rate=0.3)(b1)
        down1 = Conv2D(44, 3, activation='relu', padding='same',dilation_rate=dilate_rate, kernel_initializer='random_uniform')(b1)
        ...
        down2 = Conv2D(88, 3, activation='relu', padding='same', kernel_initializer='random_uniform')(down1pool)
        b3 = BatchNormalization()(down2)
        b3 = Dropout(rate=0.3)(b3)
        down2 = Conv2D(88, 3, activation='relu', padding='same',dilation_rate=dilate_rate, kernel_initializer='random_uniform')(b3)
        ...
        down3 = Conv2D(176, 3, activation='relu', padding='same', kernel_initializer='random_uniform')(down2pool)
        b5 = BatchNormalization()(down3)
        b5 = Dropout(rate=0.3)(b5)
        down3 = Conv2D(176, 3, activation='relu', padding='same',dilation_rate=dilate_rate, kernel_initializer='random_uniform')(b5)
        ...
        # stacked dilated convolution at the bottleneck
            dilate1 = Conv2D(176,3, activation='relu', padding='same', dilation_rate=1, kernel_initializer='random_uniform')(down3pool)
            b7 = BatchNormalization()(dilate1)
            b7 = Dropout(rate=0.3)(b7)
            dilate2 = Conv2D(176,3, activation='relu', padding='same', dilation_rate=2, kernel_initializer='random_uniform')(b7)
            b8 = BatchNormalization()(dilate2)
            b8 = Dropout(rate=0.3)(b8)
            dilate3 = Conv2D(176,3, activation='relu', padding='same', dilation_rate=4, kernel_initializer='random_uniform')(b8)
            b9 = BatchNormalization()(dilate3)
            b9 = Dropout(rate=0.3)(b9)
            dilate4 = Conv2D(176,3, activation='relu', padding='same', dilation_rate=8, kernel_initializer='random_uniform')(b9)
            b10 = BatchNormalization()(dilate4)
            b10 = Dropout(rate=0.3)(b10)
            dilate5 = Conv2D(176,3, activation='relu', padding='same', dilation_rate=16, kernel_initializer='random_uniform')(b10)
            b11 = BatchNormalization()(dilate5)
            b11 = Dropout(rate=0.3)(b11)
            dilate6 = Conv2D(176,3, activation='relu', padding='same', dilation_rate=32, kernel_initializer='random_uniform')(b11)
            if addition == 1:
            ...
            dilate1 = Conv2D(176,3, activation='relu', padding='same', kernel_initializer='random_uniform')(down3pool)
            b7 = BatchNormalization()(dilate1)
            b7 = Dropout(rate=0.3)(b7)
            dilate2 = Conv2D(176,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b7)
            b8 = BatchNormalization()(dilate2)
            b8 = Dropout(rate=0.3)(b8)
            dilate3 = Conv2D(176,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b8)
            b9 = BatchNormalization()(dilate3)
            b9 = Dropout(rate=0.3)(b9)
            dilate4 = Conv2D(176,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b9)
            b10 = BatchNormalization()(dilate4)
            b10 = Dropout(rate=0.3)(b10)
            dilate5 = Conv2D(176,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b10)
            b11 = BatchNormalization()(dilate5)
            b11 = Dropout(rate=0.3)(b11)
            dilate6 = Conv2D(176,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b11)
            if addition ==1:
                dilate_all_added = add([dilate1, dilate2, dilate3, dilate4, dilate5, dilate6])
                up3 = UpSampling2D((2, 2))(dilate_all_added)
            else:
                up3 = UpSampling2D((2, 2))(dilate6)
        up3 = Conv2D(88,3, activation='relu', padding='same', kernel_initializer='random_uniform')(up3)
        up3 = concatenate([down3, up3])
        b12 = BatchNormalization()(up3)
        b12 = Dropout(rate=0.3)(b12)
        up3 = Conv2D(88,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b12)
        b13 = BatchNormalization()(up3)
        up3 = Conv2D(88,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b13)

        up2 = UpSampling2D((2, 2))(up3)
        up2 = Conv2D(44,3, activation='relu', padding='same', kernel_initializer='random_uniform')(up2)
        up2 = concatenate([down2, up2])
        b14 = BatchNormalization()(up2)
        b14 = Dropout(rate=0.3)(b14)
        up2 = Conv2D(44,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b14)
        b15 = BatchNormalization()(up2)
        up2 = Conv2D(44,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b15)

        up1 = UpSampling2D((2, 2))(up2)
        up1 = Conv2D(22,3, activation='relu', padding='same', kernel_initializer='random_uniform')(up1)
        up1 = concatenate([down1, up1])
        b16 = BatchNormalization()(up1)
        b16 = Dropout(rate=0.3)(b16)
        up1 = Conv2D(22,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b16)
        b17 = BatchNormalization()(up1)
        up1 = Conv2D(22,3, activation='relu', padding='same', kernel_initializer='random_uniform')(b17)
